...
- App is at `http://127.0.0.1:3000` using the **Next.js production build** with `DATABASE_URL` pointing at Neon.
...
- Mutation proof includes a reload or a second route that reads the same record from Neon.
